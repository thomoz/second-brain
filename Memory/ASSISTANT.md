...
- "remind me to [X]" → `Memory/bitza.md` Reminders section
...
| "remind me"                 | `Memory/bitza.md` → under `## Reminders`                 |
| no entity named             | `Memory/bitza.md` → under `## Ideas`                     |
...
If the conversation has no clear subject, route to `Memory/bitza.md` Ideas section, or if
...
_(Future section — remind me to X commands route via bitza.md Reminders for now.)_
