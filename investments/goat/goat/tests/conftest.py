...
def _no_real_price_history_fetch(monkeypatch):
    ...
    # when insider_scan.py started sharing this fetch between the price-move
    # calc and the chart setup score note (a separate module/fetch path from
    # goat.price_history above, easy to miss).
