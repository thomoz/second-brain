...
def render_heartbeat_candidates_report(result: dict[str, Any]) -> str:
    lines = [
        ...
        "rising sector (per sector-ranking.md) showing a tight sideways base on/above a "
        "flat-to-rising 150-day MA, then a fresh breakout above its 50-day MA (webinar "
        "Step 1), with fundamentals survival context attached for you to judge yourself. "
