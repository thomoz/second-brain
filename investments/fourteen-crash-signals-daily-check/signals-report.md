...
| 6 | Record IPO/equity issuance | ok | S-1 (intent to register): 193 filing(s) in the trailing 30d vs 265 in the same window a year ago (0.73x); 424B4 (priced IPO): 49 filing(s) in the trailing 30d vs 57 in the same window a year ago (0.86x) |
| 7 | Retail piles into leverage | unknown | Equity put/call ratio 0.58 -- accumulating baseline, day 3 of 30 (different mechanism than ETF/fund-flow data -- see module docstring) |
...
| 9 | The Super Bowl signal | unknown | Next Super Bowl is 2027-02-14 (177 day(s) away) -- ad-share content is not automatable, nothing to check yet |
...
| 13 | Funding markets start choking | ok | CP-Treasury spread (DCPN3M-DTB3) -0.03pp (z=-1.65 vs trailing 365d) |
