...
|------|--------|--------|------------|
| 1 | AAPL | Technology | $4919B |
| 2 | AVGO | Technology | $1695B |
| 3 | BRK-B | Financials | $1086B |
| 4 | AMD | Technology | $1003B |
| 5 | ABBV | Health Care | $468B |
| 6 | CSCO | Technology | $420B |
| 7 | CVX | Energy | $403B |
| 8 | BAC | Financials | $392B |
| 9 | AMAT | Technology | $376B |
| 10 | DELL | Technology | $350B |
...
| 1 | Record debt issuance, hot sector (BAC) | flag | BAC: 5216 debt-prospectus filing(s) in the trailing 180d (own 730d average: 2465.8/period) -- counts filing events, not dollar principal |
...
| 6 | Record IPO/equity issuance | ok | S-1 (intent to register): 172 filing(s) in the trailing 30d vs 298 in the same window a year ago (0.58x); 424B4 (priced IPO): 23 filing(s) in the trailing 30d vs 49 in the same window a year ago (0.47x) |
| 7 | Retail piles into leverage | ok | Equity put/call ratio 0.46 (z=-1.72 vs trailing 36d mean 0.58) -- options positioning proxy, not the video's ETF/fund-flow mechanism |
| 8 | Insider selling (AAPL) | flag | AAPL: $114,459,295 sold vs $0 bought, trailing 365 days |
...
| 8 | Insider selling (CVX) | flag | CVX: $463,821,703 sold vs $0 bought, trailing 365 days |
...
| 8 | Insider selling (DELL) | flag | DELL: $3,348,135,147 sold vs $0 bought, trailing 365 days |
| 9 | The Super Bowl signal | unknown | Next Super Bowl is 2027-02-14 (143 day(s) away) -- ad-share content is not automatable, nothing to check yet |
| 10 | Most-valuable-company milestone | flag | AAPL is the largest company in the current hot-sector watchlist ($4.92T, most recently crossed the $4.5T rung) |
