> DEGRADED - Yahoo Finance rate-limited the fundamentals pass (only 0/200 ASX names returned data) (2026-09-08) - showing the last good run below.

# Cash-Value Scan

**Last run: 2026-09-08** - scanned 519 US + 200 ASX names (575 returned balance-sheet data), 9 qualify at net cash >= 50% of market cap.
...
| MTRX | Matrix Service Co | US | 68% | 32% | 300.5M USD | 6.9M USD | -1.5M USD | -1.5% | 203.5M USD | +13% | Industrials | negative FCF | 203.5M USD net cash, 300.5M USD mcap, -1.5M USD FCF - paying ~97.0M USD for the operating business. |
