...
| Ticker | Name | Type | Bucket | Dividend | 10Y Return | Status |
|--------|------|------|--------|----------|------------|--------|
| AMZN | Amazon.com, Inc. | stock | ai_postcrash | — | +572% | Large-scale real-world robotics leader using AI and automation across fulfillment and logistics, with dedicated Amazon Robotics initiatives and meaningful cost savings potential from next-gen facilities. |
