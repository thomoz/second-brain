...
| VLGEA | Village Super Market, Inc. | stock | unassigned | — | — | Felix added it to his watchlist -- waiting for it to beat recent highs. |
...
|------|--------|------|------|--------|----------|------------|--------|
| 10 | AMZN | Amazon.com, Inc. | stock | 4 | — | +572% | Large-scale real-world robotics leader using AI and automation across fulfillment and logistics, with dedicated Amazon Robotics initiatives and meaningful cost savings potential from next-gen facilities. |
| 10 | GOOGL | Alphabet Inc | stock | 4 | — | — | Crash-discount candidate added alongside AMZN/MSFT/META request 2026-09-15. Already in Post-Crash AI Watch separately -- this is the wait-for-a-broad-market-crash entry, distinct from the AI-bubble-valuation watch. |
| 10 | KSPI | Kaspi.kz | stock | 4 | — | — | Deep dive 2026-08-03: PE 7.8, debt/equity 11.9 (very low leverage), current ratio 7.06, ROE 46.7%, dividend growing +2.1%. Cheap on every hard number but qualitative moat/management evidence thin across all 9 principle frameworks (avg 40/100). No Berkshire overlap or crash-window history available. Bucket 4: want it cheaper than today before buying, not a specific-bubble timing play. |
| 10 | META | Meta Platforms Inc | stock | 4 | — | — | Crash-discount candidate added alongside GOOGL/AMZN/MSFT request 2026-09-15. Not previously on the watchlist. |
| 10 | MSFT | Microsoft Corporation | stock | 4 | — | — | Crash-discount candidate -- clean sheet, best principles-fit scores of any name assessed this session (avg 58/100; Fisher 84, Buffett 82, Munger 78, Smith 78). Opportunity signal fired: ROE 34.0% (10/10 excellent), not richly valued (PE 26.2, fair), no active flags anywhere. Dividend +9.9% YoY, debt/equity 29.1 (very good). Still AAA/Aaa rated. Only current noise is regulatory (UK CMA business-software antitrust probe, EU DMA gatekeeper review for Azure, a shareholder suit over Azure/AI-spend disclosure) -- nothing acute. Up +27.4% 1mo / +20.1% 3mo though, a real recent run -- waiting for a better/crash-driven entry rather than chasing this move, not a today price buy despite the clean fundamentals. Separate from the existing ai_postcrash bucket entry. |
| 8 | NOK | Nokia Oyj | stock | 4 | — | — | Crash-discount bucket - buy on a market-wide crash discount, not at todays price. |
...
| — | GWRE | Guidewire Software | stock | 4 | — | — | P&C insurance software, mission-critical/high switching costs (Fisher 80). PE 93.3 - too rich now, insider selling flag. Want at a crash-driven discount, not current price |
...
| — | QCLN | First Trust NASDAQ Clean Edge Green Energy Index Fund | etf | 4 | — | — | First Trust NASDAQ Clean Edge Green Energy Index Fund -- tracks the NASDAQ Clean Edge Green Energy Index; US-listed clean energy across solar, EVs, batteries, fuel cells and biofuels. Top holdings historically Tesla, First Solar, Enphase, Albemarle, ON Semiconductor. Expense ratio ~0.58%. Broader than TAN (adds EV, battery and semis exposure). Thematic, parked in Bucket 4 pending a crash-driven discount. Not yet deep-dived. |
| — | SII.TO | Sprott Inc | stock | 4 | — | — | Capital-light precious-metals/uranium asset manager. ROE 27pct, strong balance sheet, growing dividend, but 31x PE and amplifies crashes ~2x (2008 -69pct, COVID -38pct, 2022 -40pct). Good to own when the economy is good; buy at a crash-driven discount, not todays price. Stacks on existing gold (PMGOLD) and uranium (URNM/OOO) macro exposure. |
| — | TAN | Invesco Solar ETF | etf | 4 | — | — | Invesco Solar ETF -- tracks the MAC Global Solar Energy Index; global pure-play solar (panel and inverter makers, installers, polysilicon). Top holdings historically First Solar, Enphase, Nextracker, Sunrun. Expense ratio ~0.69%. Thematic and cyclical, not a Bucket 1 moat name -- parked in Bucket 4 pending a crash-driven discount. Not yet deep-dived. |
...
| — | VRSN | VeriSign | stock | 4 | — | — | Domain registry infra moat (Buffett 82, Smith 78). PE 32.4 reasonable but current ratio 0.59 poor + new Sept 2026 antitrust suit re .com pricing. Want at a crash-driven discount |
